...
class OpenAICompatibleGenerator:
    ...
    def __init__(
        ...
        self.api_key = (
            api_key
            or os.environ.get("RAG_LLM_API_KEY")
        )
    ...
    def generate(
        ...
        system_prompt = (
            ...
            "threat, detection_interpretation, uncertainty_reason, "
            "likely_attack_behavior, recommendation, containment_action, "
            "caveat, evidence_ids. "
            "The evidence_ids field must contain only IDs supplied "
        ...
        try:
            ...
            raise RuntimeError(
                "LLM endpoint could not be reached: "
                f"{exc.reason}"
            ) from exc
